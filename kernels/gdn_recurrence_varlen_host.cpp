...
void gdn_recurrence_varlen_bf16(const choreo::spanned_view<choreo::bf16, 3> & Q, const choreo::spanned_view<choreo::bf16, 3> & K, const choreo::spanned_view<choreo::bf16, 3> & V, const choreo::spanned_view<choreo::bf16, 2> & G, const choreo::spanned_view<choreo::bf16, 2> & Beta, const choreo::spanned_view<choreo::f32, 4> & State, const choreo::spanned_view<choreo::s64, 1> & Slots, const choreo::spanned_view<choreo::bf16, 3> & Out, const choreo::spanned_view<choreo::u32, 1> & CuSeqlens, choreo::stream_t _s) {
  ...
  choreo::runtime_check(Out.shape()[2] == 128, "shape inconsistent on the 8th parameter ('Out', dim: 2): expect: 128, but got " + std::to_string(Out.shape()[2]) + ".");
  ...
  choreo::runtime_check(Beta.shape()[1] == State.shape()[1], "The shapes of the 5th parameter (dim: 1) and the 6th parameter (dim: 1) are inconsistent.");
  choreo::runtime_check(State.shape()[1] == Out.shape()[1], "The shapes of the 6th parameter (dim: 1) and the 8th parameter (dim: 1) are inconsistent.");
  ...
  choreo::runtime_check((static_cast<long long>(BATCH) * 8LL < 4294967296LL), "The size of data transferred by DMA cannot exceed 2^32., 108.26");
  choreo::runtime_check((static_cast<long long>(BATCH_P1) * 4LL < 4294967296LL), "The size of data transferred by DMA cannot exceed 2^32., 109.30");
  choreo::runtime_check((static_cast<long long>(BATCH_P1) * 4LL < 4294967296LL), "The size of data transferred by DMA cannot exceed 2^32., 110.28");
  choreo::runtime_check((static_cast<long long>(MAX_SLOTS) * static_cast<long long>(NH) * 65536LL < 4294967296LL), "The size of data transferred by DMA cannot exceed 2^32., 118.27");
  choreo::runtime_check((static_cast<long long>(NH) * static_cast<long long>(TOTAL_TOKENS) * 256LL < 4294967296LL), "The size of data transferred by DMA cannot exceed 2^32., 133.27");
  choreo::runtime_check((static_cast<long long>(NH) * static_cast<long long>(TOTAL_TOKENS) * 256LL < 4294967296LL), "The size of data transferred by DMA cannot exceed 2^32., 134.27");
  choreo::runtime_check((static_cast<long long>(NH) * static_cast<long long>(TOTAL_TOKENS) * 256LL < 4294967296LL), "The size of data transferred by DMA cannot exceed 2^32., 135.27");
  choreo::runtime_check((static_cast<long long>(NH) * static_cast<long long>(TOTAL_TOKENS) * 2LL < 4294967296LL), "The size of data transferred by DMA cannot exceed 2^32., 136.27");
  choreo::runtime_check((static_cast<long long>(NH) * static_cast<long long>(TOTAL_TOKENS) * 2LL < 4294967296LL), "The size of data transferred by DMA cannot exceed 2^32., 137.30");
  choreo::runtime_check((static_cast<long long>(NH) * static_cast<long long>(TOTAL_TOKENS) * 256LL < 4294967296LL), "The size of data transferred by DMA cannot exceed 2^32., 152.21");
  choreo::runtime_check((static_cast<long long>(MAX_SLOTS) * static_cast<long long>(NH) * 65536LL < 4294967296LL), "The size of data transferred by DMA cannot exceed 2^32., 155.17");
