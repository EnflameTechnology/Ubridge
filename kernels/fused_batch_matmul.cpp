...
extern "C" __global__ void fused_batch_matmul(float *matA, float *matB, float *matTmpB, float* out, int* matA_shape, int* matB_shape)
{
...
int main(int argc, char *argv[])
{
    ...
    fused_batch_matmul<<<dim3(W, batch, 1), dim3(1, 1, 1)>>>(lhs_d, rhs_d, rhs_tmp_d, out_d, shape_lhs_d, shape_rhs_d);
