...
UNARY_OP(tops::bfloat, vbfloat, uneg_bf16, UNARY_TYPE_NEG)
UNARY_OP(tops::bfloat, vbfloat, uexp_bf16, UNARY_TYPE_EXP)
UNARY_OP(tops::bfloat, vbfloat, ulog_bf16, UNARY_TYPE_LOG)
UNARY_OP(tops::bfloat, vbfloat, usin_bf16, UNARY_TYPE_SIN)
UNARY_OP(tops::bfloat, vbfloat, ucos_bf16, UNARY_TYPE_COS)
UNARY_OP(tops::bfloat, vbfloat, uabs_bf16, UNARY_TYPE_ABS)
UNARY_OP(tops::bfloat, vbfloat, usqr_bf16, UNARY_TYPE_SQUARE)
UNARY_OP(tops::bfloat, vbfloat, usqrt_bf16, UNARY_TYPE_SQRT)
UNARY_OP(tops::bfloat, vbfloat, ugelu_bf16, UNARY_TYPE_GELU)
UNARY_OP(tops::bfloat, vbfloat, urelu_bf16, UNARY_TYPE_RELU) 
// UNARY_OP(tops::bfloat, vbfloat, uelu_bf16, UNARY_TYPE_ELU) 
UNARY_OP(tops::bfloat, vbfloat, ucopy_bf16, UNARY_TYPE_COPY) 



UNARY_OP(tops::half, vhalf, uneg_f16, UNARY_TYPE_NEG)
UNARY_OP(tops::half, vhalf, uexp_f16, UNARY_TYPE_EXP)
UNARY_OP(tops::half, vhalf, ulog_f16, UNARY_TYPE_LOG)
UNARY_OP(tops::half, vhalf, usin_f16, UNARY_TYPE_SIN)
UNARY_OP(tops::half, vhalf, ucos_f16, UNARY_TYPE_COS)
UNARY_OP(tops::half, vhalf, uabs_f16, UNARY_TYPE_ABS)
UNARY_OP(tops::half, vhalf, usqr_f16, UNARY_TYPE_SQUARE)
UNARY_OP(tops::half, vhalf, usqrt_f16, UNARY_TYPE_SQRT)
UNARY_OP(tops::half, vhalf, ugelu_f16, UNARY_TYPE_GELU)
UNARY_OP(tops::half, vhalf, urelu_f16, UNARY_TYPE_RELU)
// UNARY_OP(tops::half, vhalf, uelu_f16, UNARY_TYPE_ELU)
UNARY_OP(tops::half, vhalf, ucopy_f16, UNARY_TYPE_COPY)
...
int test() {
  ...
  ucopy_f32<<<dim3(grids, 1, 1), dim3(threads, 1, 1)>>>(size_out, lhs_d, out_d);
