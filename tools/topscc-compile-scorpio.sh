...
if [ $# -gt 1 ]; then
    ...
    topscc $KERNEL_PATH"/../"$1.cpp -arch gcu300 -O3 -std=c++17 -fPIC -ltops -o $KERNEL_PATH/$1.topsfb -Xclang -fallow-half-arguments-and-returns -D__GCU_ARCH__=300 -D__KRT_ARCH__=300 --tops-device-lib-path=$ATOMIC_PATH/lib --tops-device-lib=libatomicop.bc -D__ATOMIC_OP__ -I$ATOMIC_PATH
